  ...
  return <div className="cpm-hub">
    ...
    <main>
      ...
      : <>
        ...
        <section className="cpm-hub-panel" aria-labelledby="cpm-skillpack-heading"><h2 id="cpm-skillpack-heading">CPM Intensive — Attendee Skill Pack v1.0</h2><p>The Codex skills we built during the intensive to create the schedule, the schedule of values, and the rest of the workflow. Opens in Google Drive.</p><a href="https://drive.google.com/drive/folders/1tKrZAd8qUG5uatU9wJoAXFnlOZWWkFSr" target="_blank" rel="noopener noreferrer" className="cpm-hub-button">Open skill pack</a></section>
