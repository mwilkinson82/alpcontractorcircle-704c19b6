...
const proofStats = [
  ...
  { value: "33x", label: "Growth multiple from member examples" },
  ...
  return (
    <div ref={rootRef} className="cc-page">
      ...
      <main id="top">
        ...
        <section
          className="cc-proof-system"
          aria-label="Contractor Circle proof and IOR field session"
        >
          <div className="cc-proof-system-inner">
            <div className="cc-proof-system-head cc-caption">
              <div>
                <p className="cc-eyebrow" data-caption>
                  Proof
                </p>
            ...
            <div className="cc-ior-panel cc-proof-motion">
              <div className="cc-ior-copy">
                <span>IOR field session</span>
                <h3>See risk before it eats the margin.</h3>
                <p>
                  In this live Zoom session, Marshall walks through the
                  Indicated Outcome Report mindset: split the project into
                  profit and risk, name the exposure early, and protect the
                  margin before it disappears in the noise.
                </p>
                <div className="cc-ior-tags" aria-label="IOR method signals">
                  <span>Project source of truth</span>
                  <span>Profit / Risk split</span>
            ...
            <div className="cc-proof-evidence">
              <div className="cc-proof-signal-grid" aria-label="Proof signals">
                {proofStats.map(stat => (
                  <div className="cc-proof-signal cc-proof-motion" key={stat.value}>
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const setupProofSystem = () => {
        ...
        const videoFrame =
          proof.querySelector<HTMLElement>(".cc-ior-video-frame");
        const resultRail =
          proof.querySelector<HTMLElement>(".cc-proof-result-rail");
      ...
      gsap.utils
        ...
        .filter(
          caption =>
            ...
            !caption.closest(".cc-proof-system")
        )
        .forEach(caption => {
