  ...
  return (
    <main className="di-terms">
      ...
      <article>
        ...
        <h2>Program</h2>
        <p>The intensive is scheduled for October 16–18, 2026 and will be delivered live online. ALP may make reasonable adjustments to session order, instructors, examples or delivery mechanics without materially reducing the program.</p>
